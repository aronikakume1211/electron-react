...
const List=props=>(
    <tr>
        ...
        <td>
            <Link to={'/The-beggers/edit/'+props.data._id }style={{ marginRight: 4 }}> <span className="glyphicon glyphicon-edit"></span>Edit</Link>
            <Link to={"/The-beggers/delete/" + props.data._id} style={{ marginLeft: 4, color: "red" }} ><span className="glyphicon glyphicon-trash"></span>Delete</Link>
        </td>
    </tr>
)
export default class beggar_table extends Component {
    ...
    componentDidMount(){
        const database =new DataStore('../Beggar_Data.db');
